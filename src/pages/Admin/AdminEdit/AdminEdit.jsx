...
const ProductEdit = () => {
  ...
  return (
      <div>
            ...
            <input value = {newProduct?.price} onChange ={(e) =>createNewProduct(e)} type ='text' name = 'price' placeholder = 'Price' />
            <input value = {newProduct?.description} onChange ={(e) => createNewProduct(e)} type ='number' name = 'description' placeholder = 'Description' />
