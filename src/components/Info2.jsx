...
import {Container,Col,Row,Image,ResponsiveEmbed,Button,Carousel} from 'react-bootstrap'
...
const Info2 = () => {
    return (
            ...
            <Container >
                <h6 className="mt-5 text-center" style={{color:"blue"}}>PLAY HAS NO LIMITS</h6>
                <h1 className="text-center">Introducing PlayStation 5</h1>
                <h5 className="text-center" style={{color:"gray"}}>Unleash new gaming possibilities that you never anticipated</h5>
                <Row>
                    <Col lg={6} >
